...
public class Application implements java.io.Serializable {
	...
	@org.kie.api.definition.type.Label(value = "Outlimit Debt-to-Income Ratio")
	private java.lang.Boolean outlmitdebttoincomeratio;

	@org.kie.api.definition.type.Label(value = "Cutoff Debt-to-Income Ratio")
	private java.lang.Float cutoffdebttoincomeratio;
	...
	public java.lang.Boolean getOutlmitdebttoincomeratio() {
		return this.outlmitdebttoincomeratio;
	}

	public void setOutlmitdebttoincomeratio(
			java.lang.Boolean outlmitdebttoincomeratio) {
		this.outlmitdebttoincomeratio = outlmitdebttoincomeratio;
	}

	public java.lang.Float getCutoffdebttoincomeratio() {
		return this.cutoffdebttoincomeratio;
	}

	public void setCutoffdebttoincomeratio(
			java.lang.Float cutoffdebttoincomeratio) {
		this.cutoffdebttoincomeratio = cutoffdebttoincomeratio;
	}
	...
	public Application(com.myspace.mortgage_app.Applicant applicant,
			...
			java.lang.Boolean outlmitdebttoincomeratio,
			java.lang.Float cutoffdebttoincomeratio,
			java.lang.Integer interestrate) {
		this.applicant = applicant;
		this.property = property;
		this.errors = errors;
		this.downpayment = downpayment;
